...
std::vector<std::string> SettingsControllerImplementation::split(const std::string& s, const char delimiter) const
{
...
SettingsData SettingsControllerImplementation::getSettingsData()
{
	return settingsData;
}

void SettingsControllerImplementation::updateSettingsData(const SettingsData settingsData)
{
	this->settingsData = settingsData;
	updateSettings(settingsData);
}

void SettingsControllerImplementation::backToDefaultSettings()
{
...
void SettingsControllerImplementation::fetchSettings()
{
	std::fstream file;
...
void SettingsControllerImplementation::updateSettings(const SettingsData settingsData) const
{
	std::fstream file;
